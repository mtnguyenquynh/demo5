...
public class BookServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "view":
                ...
                break;
            case "history":
                viewPurchaseHistory(request, response);
                break;
            case "statistics":
                viewTransactionStatistics(request, response);
                break;
            default:
                response.sendRedirect(request.getContextPath() + "/BookList.jsp");
                break;
    ...
    private void viewPurchaseHistory(HttpServletRequest request, HttpServletResponse response) throws IOException {
        // code to view purchase history
    }

    private void viewTransactionStatistics(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // code to view transaction statistics
    }
